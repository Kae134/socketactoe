...
export const resolve = async (specifier, context, nextResolve) => {
    ...
    const { resolvedModule } = ts.resolveModuleName(specifier.startsWith('file:') ? fileURLToPath(specifier) : specifier, fileURLToPath(context.parentURL), tsconfig, host, moduleResolutionCache);
    // local project file
    if (resolvedModule &&
